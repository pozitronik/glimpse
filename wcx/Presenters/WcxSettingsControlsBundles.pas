{Per-group control bundles + bind helpers for the WCX settings dialog.
 Mirrors wlx/SettingsControlsBundles; lives in wcx/ to keep the shared
 SettingsGroups unit VCL-free. Names are TWcxXxxControls to prevent
 clashes with the WLX bundle unit.}
unit WcxSettingsControlsBundles;
...
type
  {MaxWorkers and MaxThreads encode across the auto-checkbox / spin-
   control pair via SettingsDlgLogic.}
