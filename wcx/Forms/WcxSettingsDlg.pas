...
uses
  ...
  Vcl.Dialogs,
  Winapi.Windows,
  WcxSettings, WcxPresetEditorModel,
  WcxSettingsRepository, WcxPresetsRepository,
  WcxSettingsControlsBundles, WcxSettingsPresenters;
...
uses
  System.Math,
  BitmapSaver, PathExpand, FFmpegExe, FFmpegCmdLine, FFmpegLocator, SettingsDlgLogic,
  SettingsDlgUI, PluginMessages, Defaults, Types,
  WcxPresets, SettingsSaveOrchestrator;
