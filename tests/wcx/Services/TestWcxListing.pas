...
type
  ...
  public
    ...
    { Entry shape contracts that the dispatch code in WcxExports relies on }
    ...
    { LegacyEntryCount — slot-numbering invariant shared with WcxExports }
...
uses
  System.SysUtils,
  BitmapSaver, FrameOffsets, FrameFileNames,
  WcxPresets, WcxListing, WcxEntryExtractors;
