{ Tests for BannerPainter: AttachBanner geometry, font fitting, wrap
...
type
  ...
  public
    ...
    { Cross-concern: AttachBanner over a pf32bit alpha-aware combined render.
      The setup uses CombinedGrid for the source bitmap; the assertions
...
uses
  ...
  Types, FrameOffsets, BannerPainter, CombinedGrid, TimecodeOverlay,
  RenderDefaults, Defaults, SettingsGroups;
