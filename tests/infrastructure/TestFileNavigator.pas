...
uses
  DUnitX.TestFramework, FileNavigator;
...
type
  ...
  public
    ...
    [Test] procedure Cache_FreshNavigator_SizeIsZero;
...
begin
  ...
  {A fresh navigator per test: its cache is empty and isolated, so no
   state leaks between tests.}
  FNav := CreateFileNavigator;
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'b.mp4',
    FNav.FindAdjacentFile(FTempDir + 'a.mp4', 'mp4', 1));
  Assert.AreEqual(FTempDir + 'c.mp4',
    FNav.FindAdjacentFile(FTempDir + 'b.mp4', 'mp4', 1));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'a.mp4',
    FNav.FindAdjacentFile(FTempDir + 'b.mp4', 'mp4', -1));
  Assert.AreEqual(FTempDir + 'b.mp4',
    FNav.FindAdjacentFile(FTempDir + 'c.mp4', 'mp4', -1));
end;
...
begin
  ...
  Assert.AreEqual('',
    FNav.FindAdjacentFile(FTempDir + 'only.mp4', 'mp4', 1));
  Assert.AreEqual('',
    FNav.FindAdjacentFile(FTempDir + 'only.mp4', 'mp4', -1));
end;
...
begin
  ...
  Assert.AreEqual('',
    FNav.FindAdjacentFile(FTempDir + 'readme.txt', 'mp4,mkv', 1));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'b.mkv',
    FNav.FindAdjacentFile(FTempDir + 'a.mp4', 'mp4,mkv,avi', 1));
  Assert.AreEqual(FTempDir + 'c.avi',
    FNav.FindAdjacentFile(FTempDir + 'b.mkv', 'mp4,mkv,avi', 1));
  Assert.AreEqual(FTempDir + 'a.mp4',
    FNav.FindAdjacentFile(FTempDir + 'c.avi', 'mp4,mkv,avi', 1));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'video.MP4',
    FNav.FindAdjacentFile(FTempDir + 'clip.mp4', 'mp4', 1));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'beta.mp4',
    FNav.FindAdjacentFile(FTempDir + 'Alpha.mp4', 'mp4', 1));
  Assert.AreEqual(FTempDir + 'Gamma.mp4',
    FNav.FindAdjacentFile(FTempDir + 'beta.mp4', 'mp4', 1));
end;
...
begin
  ...
  Assert.AreEqual('',
    FNav.FindAdjacentFile(FTempDir + 'notes.txt', 'mp4', 1));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'c.mp4',
    FNav.FindAdjacentFile(FTempDir + 'a.mp4', 'mp4', -7));
  { delta=-100 from b (idx 1): (1-100) mod 3 = -99 mod 3 = 0 -> a }
  Assert.AreEqual(FTempDir + 'b.mp4',
    FNav.FindAdjacentFile(FTempDir + 'b.mp4', 'mp4', -99));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'b.mp4',
    FNav.FindAdjacentFile(FTempDir + 'a.mp4', 'mp4', 100));
end;
...
begin
  ...
  Assert.AreEqual(FTempDir + 'a.mp4',
    FNav.FindAdjacentFile(FTempDir + 'a.mp4', 'mp4', 0));
end;
...
begin
  CreateFiles(['a.mp4', 'b.mp4', 'c.mp4']);
  Assert.IsTrue(FNav.GetFilePosition(FTempDir + 'a.mp4', 'mp4', Idx, Total));
...
begin
  CreateFiles(['a.mp4', 'b.mp4', 'c.mp4']);
  Assert.IsTrue(FNav.GetFilePosition(FTempDir + 'b.mp4', 'mp4', Idx, Total));
...
begin
  CreateFiles(['a.mp4', 'b.mp4', 'c.mp4']);
  Assert.IsTrue(FNav.GetFilePosition(FTempDir + 'c.mp4', 'mp4', Idx, Total));
...
begin
  ...
  Assert.IsTrue(FNav.GetFilePosition(FTempDir + 'lonely.mp4', 'mp4', Idx, Total));
  Assert.AreEqual(1, Idx);
...
begin
  ...
  Assert.IsTrue(FNav.GetFilePosition(FTempDir + 'b.mkv', 'mp4,mkv', Idx, Total));
  Assert.AreEqual(2, Idx);
...
begin
  ...
  Assert.IsFalse(FNav.GetFilePosition(FTempDir + 'foreign.xyz', 'mp4,mkv', Idx, Total));
...
begin
  ...
  Assert.IsFalse(FNav.GetFilePosition(FTempDir + 'phantom.mp4', 'mp4', Idx, Total));
