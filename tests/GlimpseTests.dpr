...
uses
  ...
  ClipboardTemp in '..\src\domain\Clipboard\ClipboardTemp.pas',
  TestClipboardTemp in 'domain\Clipboard\TestClipboardTemp.pas',
  ...
  FrameCountPolicy in '..\src\domain\Frame\FrameCountPolicy.pas',
  FrameCountPolicyTests in 'domain\Frame\FrameCountPolicyTests.pas',
  ...
  TestSelectionHotkeyDefaults in 'domain\Hotkeys\TestSelectionHotkeyDefaults.pas',
  ...
  TestFrameCellStore in 'wlx\Widgets\TestFrameCellStore.pas',
  TestFrameCellStoreInvert in 'wlx\Widgets\TestFrameCellStoreInvert.pas',
  TestFrameGeometry in 'wlx\Widgets\TestFrameGeometry.pas',
  TestFrameViewRenderer in 'wlx\Widgets\TestFrameViewRenderer.pas',
  ...
  ClipboardTempResolver in '..\src\infrastructure\ClipboardTempResolver.pas',
  TestClipboardTempResolver in 'infrastructure\TestClipboardTempResolver.pas',
  ClipboardTempSweeper in '..\src\infrastructure\ClipboardTempSweeper.pas',
  TestClipboardTempSweeper in 'infrastructure\TestClipboardTempSweeper.pas',
  ...
  ExportTargetResolver in '..\wlx\Services\ExportTargetResolver.pas',
  FrameExportTypes in '..\wlx\Services\FrameExportTypes.pas',
  FrameSaver in '..\wlx\Services\FrameSaver.pas',
  FrameCopier in '..\wlx\Services\FrameCopier.pas',
  ...
  FrameRenderLayout in '..\wlx\Services\FrameRenderLayout.pas',
  CellBitmapScaler in '..\wlx\Services\CellBitmapScaler.pas',
  ...
  TestFrameSaver in 'wlx\Services\TestFrameSaver.pas',
  TestFrameCopier in 'wlx\Services\TestFrameCopier.pas',
