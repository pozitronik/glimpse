...
procedure TTestClipboardImage.BuildDropFilesHandle_EmptyReturnsZero;
begin
...
procedure TTestClipboardImage.BuildDropFilesHandle_HappyPath;
const
...
procedure TTestClipboardImage.BuildDropFilesHandle_IsWideAndDoubleNullTerminated;
const
