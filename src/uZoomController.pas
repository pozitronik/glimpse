...
function NormalizeViewportCenter(ScrollPos, ViewportSize,
  ContentSize: Integer): Double;
...
function DenormalizeViewportCenter(NormPos: Double;
  NewContentSize, ViewportSize: Integer): Integer;
