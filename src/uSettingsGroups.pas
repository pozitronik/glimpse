...
uses
  System.UITypes,
  uBitmapSaver, uStatusBarLayout, uTypes, uUnicodeIniFile;
...
type
  ...
  {[statusbar] group — user-configurable token template + font +
   auto-width measurement policy. The template feeds uStatusBarTemplate.Parse;
...
begin
  ...
  {Background literal mirrors uSettings.DEF_BACKGROUND; CellGap literal
   mirrors uSettings.DEF_CELL_GAP. The two constants live in uSettings
   ...
   between uSettingsGroups and uSettings.}
